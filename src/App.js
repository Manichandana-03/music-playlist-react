...
class App extends Component {
  ...
  getFilteredTrackList = () => {
    ...
    const filteredData = trackList.filter(eachTrack =>
  ...
  updateList = id => {
    ...
    const filteredData = trackList.filter(eachTrack => eachTrack.id !== id)
    this.setState({trackList: filteredData})
  }

  render() {
    const {searchInput} = this.state
    const searchResults = this.getFilteredTrackList()
      ...
      <div className="container">
        ...
        <div className="con-2">
          <div className="header-con">
            <h2 className="sub-heading">Songs Playlist</h2>
